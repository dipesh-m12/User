...
import { Business, comprehensiveMockBusinesses } from '../../constants/exploreMockData';
    ...
    return (
        <>
                                ...
                                <HStack space="md" alignItems="flex-start">
                                    ...
                                    <VStack flex={1}>
                                        ...
                                        <Text
                                            ...
                                            lineHeight={20}
                                        >
                                            Scan any business QR code to instantly join their queue and
            ...
            <ConfirmationModal
                ...
                message={`This will initiate a call to ${selectedQueue?.business.name || 'the business'
            ...
            <ConfirmationModal
                ...
                title="Leave Queue ?"
                message={`Are you sure you want to leave the queue for ${selectedQueue?.service.name || 'this service'
                    } at ${selectedQueue?.business.name || 'the business'}?\nYou will lose your current position (${selectedQueue?.position || '-'
