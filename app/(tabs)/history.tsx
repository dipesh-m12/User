...
export default function HistoryScreen() {
  ...
  const [selectedTicket, setSelectedTicket] = useState<HistoryTicket | null>(
    null
  );
        ...
        >
          ...
          <VStack flex={1}>
            ...
            <HStack alignItems="center" space="sm" mb={AppTheme.spacing.xs}>
              ...
              >
                {ticket.services.length} service
                {ticket.services.length > 1 ? "s" : ""} • Position #
          ...
          <VStack alignItems="flex-end">
            <Text
              fontSize={AppTheme.typography.fontSizes.sm}
              color={
                isDark ? AppTheme.colors.gray[500] : AppTheme.colors.gray[500]
              }
              mb={AppTheme.spacing.xs}
            >
        ...
        <ScrollView flex={1} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Heading
              size="xl"
              color={
                isDark ? AppTheme.colors.gray[50] : AppTheme.colors.blue[900]
              }
              fontWeight="700"
