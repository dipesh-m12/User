...
export default function ExploreScreen() {
  ...
  const [sortBy, setSortBy] = useState<"distance" | "rating" | "popularity">(
    "distance"
  );
        ...
        <ScrollView flex={1} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            >
              ...
              <Text
                color={isDark ? AppTheme.colors.text.dark.subtle : "#4CAF50"}
                  ...
                  >
                    {sortOptions.map((option, index) => (
                      <Pressable
                        ...
                        onPress={() => {
                          setSortBy(
                            option.value as "distance" | "rating" | "popularity"
                          );
