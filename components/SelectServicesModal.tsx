                            ...
                            {business.services.map((service) => {
                                ...
                                return (
                                    <Pressable
                                        ...
                                        backgroundColor={isSelected ? AppTheme.colors.blue[50] : (isDark ? AppTheme.colors.gray[800] : "#ffffff")}
                                        borderWidth={2}
                                        borderColor={isSelected ? AppTheme.colors.blue[500] : AppTheme.colors.gray[300]}
                                        borderRadius={16}
                                        ...
                                        <HStack alignItems="flex-start" justifyContent="space-between">
                                            <VStack flex={1}>
                                                ...
                                                <HStack alignItems="center" space="sm" mb={4}>
                                                    <Text
                                                        color={isSelected ? AppTheme.colors.blue[600] : (isDark ? AppTheme.colors.gray[100] : AppTheme.colors.blue[900])}
                                                        fontWeight="700"
                                                        fontSize={16}
                                                    >
                                                        {service.name}
                                            ...
                                            <VStack alignItems="center" ml={AppTheme.spacing.md}>
                                                <Icon name="schedule" size={16} color={AppTheme.colors.gray[500]} />
                                                <Text
                    ...
                    >
                        <VStack space="md">
                            ...
                            <Pressable
                                ...
                                alignItems="center"
                            >
                                <Text color={AppTheme.colors.gray[700]} fontWeight="700" fontSize={16}>
                                    Cancel
                                </Text>
                            </Pressable>
                            ...
                            <Pressable
                                onPress={onJoinQueue}
                                backgroundColor={selectedServices.length > 0 ? AppTheme.colors.blue[600] : AppTheme.colors.gray[400]}
                                borderRadius={AppTheme.borderRadius.lg}
                                py={14}
                                alignItems="center"
                            ...
                            >
                                <Text color="#ffffff" fontWeight="700" fontSize={16}>
                                    Join Queue ({selectedServices.length} service{selectedServices.length !== 1 ? 's' : ''})
                                </Text>
                            </Pressable>
                        </VStack>
                    </Box>
